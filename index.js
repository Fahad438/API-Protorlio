...
const ExperiencesOmar = require("./models/ExpOmar")
...
app.delete("/Fahad/:id", async (req, res) => {
...
app.put("/Fahad/:id", async (req, res) => {
    const id = req.params.id
...
//Exp endpoint post data
app.post("/Omar", async (req, res) => {

    //crate new opject with type Experiences
    const newExperiences = new ExperiencesOmar()
    //take value from body and put it in var
    const startDate = req.body.startDate
    const endDate = req.body.endDate
    const nameJop = req.body.nameJop
...
//Exp endpoint get data
app.get("/Omar", async (req, res) => {

    const exp = await ExperiencesOmar.find();

    res.json(exp)
})
//Exp endpoint delete data
app.delete("/Omar/:id", async (req, res) => {
    const id = req.params.id

    const deleteExp = await ExperiencesOmar.findByIdAndDelete(id)

    res.json(deleteExp)
})
//Exp endpoint update data
app.put("/Omar/:id", async (req, res) => {
    const id = req.params.id
    const upDate = await ExperiencesOmar.findById(id)
    console.log(upDate)
    const startDate = req.body.startDate
    const endDate = req.body.endDate
    const nameJop = req.body.nameJop
